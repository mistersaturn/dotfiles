...
awful.screen.connect_for_each_screen(function(s)
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({ position = "top", screen = s, width ="1800", height = "20", opacity = "0.8", shape = rect_shape })
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift"    }, "b", function () awful.util.spawn("xfce4-terminal -e links") end,
      {description = "Links Browser (Terminal)", group = "browsers" }),
    awful.key({ modkey,           }, "f", function () awful.util.spawn("xfce4-terminal -e ranger") end,

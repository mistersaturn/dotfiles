...
awful.screen.connect_for_each_screen(function(s)
	...
	awful.tag({ " home ", " dev ", " www ", " media ", " gfx ", " audio " }, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(
	...
	end, { description = "Librewolf", group = "browsers" }),
	awful.key({ modkey, "Shift" }, "b", function()
		awful.util.spawn("xfce4-terminal -e links")
	end, { description = "Links Browser (Terminal)", group = "browsers" }),
	awful.key({ modkey }, "f", function()
		awful.util.spawn("xfce4-terminal -e ranger")
	end, { description = "Ranger File Manager", group = "terminal apps" }),
	awful.key({ modkey }, "r", function()
		awful.spawn.with_shell("rofi -show drun")
	end, { description = "rofi", group = "launcher/switcher" }),

...
theme.taglist_squares_sel = theme_assets.taglist_squares_sel(taglist_square_size, theme.gtk.header_button_border_color)
theme.taglist_squares_unsel =
	theme_assets.taglist_squares_unsel(taglist_square_size, theme.gtk.header_button_border_color)
-- Or disable them:
--theme.taglist_squares_sel = nil
--theme.taglist_squares_unsel = nil

-- Generate wallpaper:
local wallpaper_bg = theme.gtk.bg_color
local wallpaper_fg = theme.gtk.base_color
